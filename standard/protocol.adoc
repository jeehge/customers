...
== SMS 전송 요청 정보 Push Payload (Server -> Android)
...
== 신규 SMS Sync 요청 Push Payload (Server -> PC)
...
== 신규 MMS Sync 요청 Push Payload (Server -> PC)
